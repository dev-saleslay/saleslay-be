import { decryptEmailApiKey } from "./email-api-key-crypto";
import {
  getSendGridApiKey,
  isSendGridConfigured as isSendGridConfiguredOnServer,
} from "./sendgrid-email-provision";
import {
  getResendApiKey,
  getResendDefaultFromEmail as getResendDefaultFromEnv,
  isResendConfigured as isResendConfiguredOnServer,
} from "./resend-mail";
import { getSendGridDefaultFromEmail as getSendGridDefaultFromEnv } from "./sendgrid-send-mail";
